...
export default function MapPoolScene({ matchData }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'absolute', bottom: '60px', left: '80px', color: 'rgba(255,255,255,0.26)', fontSize: '11px', fontWeight: '900', letterSpacing: '1.8px', textTransform: 'uppercase' }}>MATCH_SEQUENCE_SYS // FRIES.CUP.BROADCAST</div>
    </div>
  );
}