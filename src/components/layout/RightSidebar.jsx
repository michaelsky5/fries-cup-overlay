...
export default function RightSidebar({ previewScene, showRightColumn, density = 'standard', densityTokens }) {
  ...
  const statusItems = [
    { label: tr('rightSidebar.statusProgram'), value: matchData.globalScene || 'LIVE', color: '#2ecc71' },
    { label: tr('rightSidebar.statusPreview'), value: previewScene || 'LIVE', color: COLORS.yellow },
    { label: tr('rightSidebar.statusTicker'), value: matchData.tickerMode || 'OFF', color: COLORS.white },
    { label: tr('rightSidebar.statusComms'), value: matchData.activeComms || 'OFF', color: COLORS.white },
    { label: tr('rightSidebar.statusVideo'), value: formatVideoProgress(), color: COLORS.white }
  ];
