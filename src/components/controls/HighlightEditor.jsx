  ...
  >
    <div style={{ display: 'grid', gap }}>
      ...
      <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
        ...
        <button
          style={{ ...outlineBtn, padding: '0 10px' }}
          ...
          >
            ...
            >
              <div>
                ...
                >
                  {tr('highlightEditor.playbackQueue')}
                </div>
              </div>
              ...
              <button
                style={{
                  ...
                  fontSize: '10px',
                  letterSpacing: '0.5px',
                  display: highlightPlaylist.length > 0 ? 'flex' : 'none'
                }}
        ...
        right={
          <div style={{ display: 'flex', gap: '8px' }}>
            ...
            <button
              style={{
                ...softBtn,
                backgroundColor: 'rgba(244,195,32,0.15)',
                color: COLORS.yellow,
                border: `1px solid ${COLORS.yellow}`,
                padding: density === 'spacious' ? '0 14px' : '0 12px'
              }}
              onClick={fetchLatestReplay}
            >
                ...
                <div style={{ display: 'grid', gap }}>
                  ...
                  <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
                    <button
                      style={{
                        ...actionBtn,
                        backgroundColor: isActive ? 'rgba(244,195,32,0.2)' : COLORS.red,
                        color: isActive ? COLORS.yellow : '#fff',
                        border: isActive ? `1px solid ${COLORS.yellow}` : 'none',
                        padding: density === 'spacious' ? '0 12px' : '0 10px'
                      }}
                      onClick={() => handlePlayNow(v.path)}
                    >
                      {isActive ? tr('highlightEditor.playing') : tr('highlightEditor.playNow')}
                    </button>
